    ...
    <>
      <div className="grid grid-cols-12 gap-4">
        <div className="col-span-12">
          <div className="font-semibold text-4xl text-center mx-auto w-6/12">
            I design and code beautifully simple things, and I love what I do.
          </div>
        </div>
      </div>
      <div className="grid grid-cols-12 mt-12">
        <div className="col-span-4 col-start-3 bg-white text-black rounded-l-[40px] py-10 px-12">
        ...
        <div className="col-span-4 bg-white text-black rounded-r-[40px] py-10 px-12">
          <div className="text-center">
            <div className="rounded-full bg-gradient-to-r to-primary from-purple-500 w-16 h-16 flex items-center justify-center mx-auto">
